//  Zig Perlin3D
//  Adapted from: https://github.com/vExcess/zig-perlin3d
//  Optimized 3D Perlin Noise for Zig
...
pub const PerlinGenerator = struct {
    ...
    pub fn init(allocator: *const std.mem.Allocator, seed: u64) !PerlinGenerator {
        if (!initialized) {
            var i: usize = 0;
    ...
    pub fn seedNoise(self: *PerlinGenerator, seed: u64) !void {
